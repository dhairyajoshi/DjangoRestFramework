...
class NewUser(AbstractBaseUser, PermissionsMixin):
    ...
    pfp= models.ImageField(_("Image"),upload_to=upload_to_pfp,default='pfps/default.png')
    cfp= models.ImageField(_("Image"),upload_to=upload_to_cfp,default='cfps/default.png')
